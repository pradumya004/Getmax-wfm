...
const modules = [
  {
    ...
    description:
      "Streamline your RCM processes with intelligent automation and real-time tracking.",
  ...
  },
  {
    ...
    description:
      "Ensure accuracy with AI-powered QA audits and comprehensive scoring systems.",
  ...
  },
  {
    ...
    description:
      "Monitor compliance with real-time SLA tracking and automated escalations.",
    color: "from-[#39ff14] to-[#00ff88]",
  },
  {
    icon: Target,
    ...
    description:
      "Smart claim distribution based on priority, aging, and team capacity.",
    color: "from-[#00ff88] to-[#39ff14]",
  },
  {
    icon: Trophy,
    ...
    description:
      "Boost engagement with XP tracking, badges, and competitive leaderboards.",
    color: "from-[#39ff14] to-[#00ff88]",
  },
  {
    icon: TrendingUp,
    ...
    description:
      "Real-time insights into productivity, revenue, and performance metrics.",
    color: "from-[#00ff88] to-[#39ff14]",
  },
];
...
const testimonials = [
  {
    ...
    content:
      "GetMax transformed our revenue cycle. 40% increase in productivity and 99.2% SLA compliance.",
    rating: 5,
  },
  {
    ...
    content:
      "The gamification features boosted our team morale while maintaining exceptional quality scores.",
    rating: 5,
  },
  {
    name: "Lisa Rodriguez",
    ...
    content:
      "Real-time analytics and automated workflows reduced our claim processing time by 60%.",
    rating: 5,
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Automate Your RCM Operations with Confidence – Workforce, Quality & Revenue Management, All in One Platform. HIPAA compliant, SOC2 certified."
        />
      </Helmet>
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                {[
                  ...
                  >
                    <div className="text-3xl font-bold text-[#39ff14] text-glow">
                      {stat.value}
                    </div>
        ...
        <section id="testimonials" className="py-20 px-6 bg-black/20">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See how GetMax RCM is transforming revenue cycle operations
                    ...
                    <CardHeader>
                      <div className="flex items-center space-x-1 mb-4">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <Star
                            key={i}
                            className="h-5 w-5 fill-[#39ff14] text-[#39ff14]"
                          />
                        ))}
                      </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                ...
                RCM to optimize their revenue cycle
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  AI-powered revenue cycle management platform for healthcare
                  organizations.
                </p>
              </div>

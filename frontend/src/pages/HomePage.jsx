...
import { ArrowRight, ChevronDown, Star , Lock, Eye, Award, Database, Key, FileCheck, Menu, X, Users, Shield, TrendingUp, BarChart3, Settings, Zap, Clock, Play, Sparkles,  Mail, 
      Phone, 
      MapPin, 
      CheckCircle, ChevronRight } from 'lucide-react';
...
const Button = ({ children, size, variant, className, onClick }) => {
  const baseClasses = "inline-flex items-center justify-center rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl";
...
const [isMenuOpen, setIsMenuOpen] = useState(false);
  ...
  const modules = [
    {
      ...
      description: "Optimize team productivity with intelligent scheduling, performance tracking, and resource allocation across all departments.",
      icon: Users,
      color: "from-cyan-400 to-blue-500",
      gradient: "from-cyan-500/20 to-blue-600/20",
      hoverGradient: "from-cyan-400/30 to-blue-500/30",
      features: ["Smart Scheduling", "Performance Analytics", "Resource Optimization"]
    },
    {
      title: "Quality Assurance",
      description: "Ensure compliance and accuracy with automated quality checks, audit trails, and comprehensive reporting systems.",
      icon: Shield,
    ...
    },
    {
      ...
      description: "Maximize revenue potential through intelligent claim processing, denial management, and payment optimization.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Get deep insights with real-time dashboards, predictive analytics, and customizable reporting tools.",
      icon: BarChart3,
    ...
    },
    {
      ...
      description: "Streamline operations with intelligent automation, workflow optimization, and seamless system integrations.",
      icon: Settings,
    ...
    },
    {
      ...
      description: "Accelerate your operations with lightning-fast processing, optimized workflows, and intelligent prioritization.",
      icon: Zap,
      color: "from-purple-400 to-blue-500",
      gradient: "from-purple-500/20 to-blue-600/20",
      hoverGradient: "from-purple-400/30 to-blue-500/30",
      features: ["Fast Processing", "Smart Prioritization", "Optimized Workflows"]
    }
  ];
  ...
  const testimonials = [
  {
    ...
    content: "GetMax RCM increased our revenue by 35% in just 6 months. The AI-powered denial management is revolutionary.",
    rating: 5
  },
  {
    name: "Michael Chen",
    ...
    content: "The automation features saved us 20 hours per week on manual tasks. Our staff can now focus on patient care.",
    rating: 5
  },
  {
    ...
    content: "Outstanding support team and intuitive interface. Our claim approval rate improved from 78% to 94%.",
    rating: 5
  }
];
...
const socialLinks = [
  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 group cursor-pointer">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400 -mt-1">Revenue Cycle Management</div>
            </div>
          </div>
              ...
              >
                ...
                >
                  ...
                  {item.hasDropdown && (
                    <ChevronDown className={`h-4 w-4 transition-all duration-300 ${
                      activeDropdown === item.name ? 'rotate-180 text-cyan-400' : ''
                    }`} />
                  )}
                ...
                {item.hasDropdown && activeDropdown === item.name && (
                  <div className="absolute top-full left-0 mt-2 w-64 bg-slate-900/95 backdrop-blur-xl rounded-xl shadow-2xl border border-cyan-400/20 py-3 shadow-cyan-500/10">
                    ...
                    {(item.name === 'Solutions' ? solutionsDropdown : resourcesDropdown).map((dropdownItem, index) => (
                      <a
                        key={dropdownItem}
                        href="#"
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            >
              <a className="relative z-10" onClick={() => setShowSignup(true)}>Get Started</a>
                ...
                <div key={item.name} style={{ animationDelay: `${index * 100}ms` }}>
                  ...
                  {item.hasDropdown && (
                    <div className="ml-6 mt-2 space-y-2">
                      {(item.name === 'Solutions' ? solutionsDropdown : resourcesDropdown).map((dropdownItem) => (
                        <a
                          key={dropdownItem}
                          href="#"
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="opacity-100">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-4xl mx-auto drop-shadow-lg font-medium">
              ...
              <br />
              <span className="text-blue-200">Built for RCM vendors, billing companies, and healthcare providers.</span>
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto drop-shadow-lg font-medium">
              Comprehensive suite of tools designed to optimize every aspect of your 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {modules.map((module, index) => (
              ...
              >
                {/* Card glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-r ${module.hoverGradient} rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-110`}></div>
                
                {/* Main card */}
                <div className={`relative bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 group-hover:border-cyan-400/50 rounded-2xl p-8 h-full transition-all duration-500 transform group-hover:scale-105 group-hover:-translate-y-2 shadow-xl group-hover:shadow-2xl`}>
                  {/* Icon container */}
                  <div className="relative mb-6">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${module.color} flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                      <module.icon className="h-8 w-8 text-white" />
                    </div>
                    <div className={`absolute inset-0 w-16 h-16 rounded-2xl bg-gradient-to-r ${module.color} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500`}></div>
                  </div>
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center px-8 py-4 bg-slate-900/50 backdrop-blur-xl rounded-full border border-cyan-400/30 shadow-lg">
              ...
              <span className="text-gray-300 mr-4">Ready to transform your RCM operations?</span>
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-400 rounded-full blur-3xl animate-pulse" style={{animationDelay: '0.5s'}}></div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          ...
          <p className="text-xl text-blue-100/80 max-w-3xl mx-auto leading-relaxed">
            See how GetMax RCM is transforming revenue cycle operations across healthcare organizations worldwide
          </p>
        </motion.div>
              ...
              <Card className="relative bg-white/5 backdrop-blur-xl border border-white/20 hover:border-white/40 transition-all duration-300 h-full overflow-hidden shadow-2xl hover:shadow-blue-500/20 rounded-2xl">
                ...
                <CardHeader className="relative z-10 pb-4">
                  ...
                  <CardDescription className="text-blue-50/90 text-base leading-relaxed font-medium italic relative">
                    <span className="text-2xl text-blue-300/60 absolute -top-2 -left-2">"</span>
                ...
                <CardContent className="relative z-10 pt-0">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200/70 text-sm">{testimonial.company}</p>
                    </div>
                  </div>
 ...
 <section id="compliance" className="relative py-24 px-6 ">
    {/* Animated background elements */}
      <div className="absolute inset-0 opacity-15">
        ...
        <div className="absolute bottom-32 right-16 w-48 h-48 bg-purple-400 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute top-1/3 right-1/4 w-32 h-32 bg-indigo-400 rounded-full blur-3xl animate-pulse" style={{animationDelay: '0.8s'}}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className="text-xl text-blue-100/80 mb-16 max-w-4xl mx-auto leading-relaxed">
            ...
            ensuring the highest level of protection for your healthcare information
          </p>
 ...
 <section id="CTA" className="relative py-24 px-6 ">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-purple-400 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-400 rounded-full blur-3xl animate-pulse" style={{animationDelay: '0.5s'}}></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className="text-xl text-blue-100/80 mb-12 max-w-4xl mx-auto leading-relaxed">
            Join hundreds of healthcare organizations already using GetMax RCM to optimize their revenue cycle and maximize their financial performance
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="text-sm text-blue-100 font-medium">{benefit}</div>
              </motion.div>
            ))}
          </div>
        </motion.div>
 ...
 <footer className="relative py-16 px-6 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 overflow-hidden text-white">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-32 right-32 w-80 h-80 bg-purple-400 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-400 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.8s' }} />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-32 right-1/4 animate-float" style={{ animationDelay: '2s' }}>
          <Sparkles className="h-4 w-4 text-purple-300/30" />
        </div>
        <div className="absolute bottom-24 left-1/3 animate-float" style={{ animationDelay: '1s' }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-3xl font-bold text-white mb-4">
                Stay Updated with <span className="bg-gradient-to-r from-blue-200 to-purple-200 bg-clip-text text-transparent">GetMax RCM</span>
              </h3>
              <p className="text-blue-100/80 text-lg">
                Get the latest updates on RCM trends, product features, and industry insights delivered to your inbox.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">GetMax RCM</span>
            </div>

            <p className="text-blue-100/80 text-lg mb-6">
              AI-powered revenue cycle management platform transforming healthcare organizations worldwide with intelligent automation and analytics.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links], categoryIndex) => (
            ...
            >
              <h4 className="text-white font-bold text-lg mb-6 capitalize">{category}</h4>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-blue-200/80 text-sm">© 2024 GetMax RCM. All rights reserved.</p>
            <div className="flex gap-6">
              <a href="#" className="text-blue-200/80 hover:text-white text-sm">🔒 Security</a>
              <a href="#" className="text-blue-200/80 hover:text-white text-sm">📊 Status</a>
              <a href="#" className="text-blue-200/80 hover:text-white text-sm">🗺️ Sitemap</a>
            </div>
